...
typedef struct{
 ...
 STD_RetunType dc_motor_intialize(dc_motor_config *dc_motor_config);
...
# 3 "ECAL_layer/DC_MOTOR/ecu_dc_motor.c" 2
 ...
 STD_RetunType dc_motor_intialize(dc_motor_config *dc_motor_config){
    ...
    pin_config_t _Motor_A[2]={{.pin=dc_motor_config->Motor_A_PIN[0].M_pin,
            .port=dc_motor_config->Motor_A_PIN[0].M_port,
            .logic=dc_motor_config->Motor_A_PIN[0].pin_state,.dirction=OUTPUT},
            {
                .pin=dc_motor_config->Motor_A_PIN[1].M_pin,
            .port=dc_motor_config->Motor_A_PIN[1].M_port,
            .logic=dc_motor_config->Motor_A_PIN[1].pin_state,.dirction=OUTPUT
            }
    };
       pin_config_t _Motor_B[2]={{.pin=dc_motor_config->Motor_B_PIN[0].M_pin,
            .port=dc_motor_config->Motor_B_PIN[0].M_port,
            .logic=dc_motor_config->Motor_B_PIN[0].pin_state,.dirction=OUTPUT},
            {
                .pin=dc_motor_config->Motor_B_PIN[1].M_pin,
            .port=dc_motor_config->Motor_B_PIN[1].M_port,
            .logic=dc_motor_config->Motor_B_PIN[1].pin_state,.dirction=OUTPUT
            }
    };
