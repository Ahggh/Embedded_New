# 1 "ECAL_layer/PIC18f_MCAL_gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECAL_layer/PIC18f_MCAL_gpio.c" 2
...
# 1 "ECAL_layer/PIC18f_MCAL_gpio.h" 1
# 11 "ECAL_layer/PIC18f_MCAL_gpio.h"
...
# 11 "ECAL_layer/PIC18f_MCAL_gpio.h" 2

# 1 "ECAL_layer/Mcal_device_config.h" 1
# 12 "ECAL_layer/PIC18f_MCAL_gpio.h" 2

# 1 "ECAL_layer/mcal_std_types.h" 1
# 12 "ECAL_layer/mcal_std_types.h"
# 1 "ECAL_layer/std_libraries.h" 1
# 10 "ECAL_layer/std_libraries.h"
...
# 10 "ECAL_layer/std_libraries.h" 2
...
# 11 "ECAL_layer/std_libraries.h" 2
...
# 12 "ECAL_layer/std_libraries.h" 2
# 12 "ECAL_layer/mcal_std_types.h" 2

# 1 "ECAL_layer/compiler.h" 1
# 11 "ECAL_layer/compiler.h"
...
# 11 "ECAL_layer/compiler.h" 2
# 13 "ECAL_layer/mcal_std_types.h" 2
# 32 "ECAL_layer/mcal_std_types.h"
typedef unsigned char uint8_t;
...
# 13 "ECAL_layer/PIC18f_MCAL_gpio.h" 2
...
# 158 "ECAL_layer/PIC18f_MCAL_gpio.h"
...
# 7 "ECAL_layer/PIC18f_MCAL_gpio.c" 2


volatile uint8_t *tris_reg[5]={&(*((volatile portA_tris *)0xF92)),&(*((volatile TRISBbits_t *)0xF93)),&(*((volatile TRISCbits_t *)0xF94))};

volatile uint8_t *lat_reg[5]={&(*((volatile portA_lat *)0xF89)),&(*((volatile LATBbits_t *)0xF8A)),&(*((volatile LATCbits_t *)0xF8B))};

volatile uint8_t *port_reg[]={&(*((volatile portA_port *)0xF80)),&(*((volatile PORTBbits_t *)0xF81)),&(*((volatile PORTCbits_t *)0xF82))};
...
STD_RetunType gpio_pin_dirction_intialize(const pin_config_t*_pin_config){
    uint8_t ret=(STD_RetunType)0x01 ;
    if((_pin_config==((void*)0))||(_pin_config->pin>7)||(_pin_config->port>5))
    {
    ...
    else
    {
        ...
        {
            case OUTPUT:
         (*tris_reg[_pin_config->port]&=~((uint8_t)1 <<_pin_config->pin));
                break;
            case INPUT:
              (*tris_reg[_pin_config->port]|=((uint8_t)1 <<_pin_config->pin));
            default:
...
STD_RetunType gpio_pin_write_logic(const pin_config_t*_pin_config, LOGIC_STATE logic ){
    ...
    else
    {
        ...
        {
            case LOW:
         (*lat_reg[_pin_config->port]&=~((uint8_t)1 <<_pin_config->pin));
                break;
            case HIGH:
              (*lat_reg[_pin_config->port]|=((uint8_t)1 <<_pin_config->pin));
            default:
...
STD_RetunType gpio_pin_read_logic(const pin_config_t*_pin_config, LOGIC_STATE *logic ){
    ...
    if((_pin_config==((void*)0))||(_pin_config->pin>7)||(_pin_config->port>4))
    {
        ret=(STD_RetunType)0x00 ;
    ...
    {
     *logic =((*port_reg[_pin_config->port]>>_pin_config->pin)&(uint8_t)1);
    }
    return ret;
...
STD_RetunType gpio_pin_toggle_logic(const pin_config_t*_pin_config){
 ...
 STD_RetunType gpio_port_get_dirction_status(PORT_INDEX port,uint8_t *dirction_status ){
                  STD_RetunType ret=(STD_RetunType)0x01 ;
    if(port>((uint8_t)5 -1)||(dirction_status==((void*)0)))
    {
        ret=(STD_RetunType)0x00 ;
 ...
 STD_RetunType gpio_port_read_logic(PORT_INDEX port,uint8_t *logic ){
    STD_RetunType ret=(STD_RetunType)0x01 ;
    if(port>((uint8_t)5 -1)||(logic==((void*)0)))
    {
        ret=(STD_RetunType)0x00 ;
